...
var callingCode = document.getElementById('calling-code');
...
function fetchData() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('https://ipapi.co/json/')
                        ...
                        response.json().then(function (jsonData) {
                            ...
                            jsonData.organisation && organisation != null ? organisation.textContent = jsonData.organisation : organisation.textContent = '-';
                        });
                    })
